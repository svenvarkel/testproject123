    ...
    extends Mageflow_Connect_Controller_AbstractController
{
    ...
    public function getcompaniesAction()
    {
        ...
        if (Mage::app()->getStore()->getConfig(Mageflow_Connect_Model_System_Config::API_URL) != '') {
            ...
            $response->status = 0;
            $response->error = true;
            $response->statusmessage = 'API URL not defined. Please set API URL, save configuration and try again.';
        }
